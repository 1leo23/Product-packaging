...
generate_overlay_slices(
    mri_path=r"D:\brainAgePrediction\app\Product-packaging\Grad-cam切片(待刪)\test\preprocessing.nii.gz",
    cam_path=r"D:\brainAgePrediction\app\Product-packaging\Grad-cam切片(待刪)\test\gradCAM.nii.gz",
    output_dir=r"D:\brainAgePrediction\app\Product-packaging\Grad-cam切片(待刪)\test\output"
)
'''
